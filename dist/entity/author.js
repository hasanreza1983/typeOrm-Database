...
var Author = exports.Author = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)(), _dec3 = (0, _typeorm.Column)("text"), _dec4 = (0, _typeorm.OneToMany)(function (type) {
   return _Post.Photo;
}, function (photo) {
   return photo.author;
}), _dec(_class = (_class2 = function Author() {
   ...
   _initDefineProp(this, "photos", _descriptor3, this);
